...
//   revealFront.style.clipPath.setProperty = `circle(8em at ${mouseX}px ${mouseY}px);`;
//   circle.style.transform.setProperty = `translate(${mouseX}px, ${mouseY}px)`;
// });
document.addEventListener("mousemove", (e) => {
  document.documentElement.style.setProperty("--mouseX", e.offsetX);
  document.documentElement.style.setProperty("--mouseY", e.offsetY);
});
